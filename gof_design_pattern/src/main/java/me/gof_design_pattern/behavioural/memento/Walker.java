package me.gof_design_pattern.behavioural.memento;
...
public class Walker {
	...
	public double walk(String action) {
		...
		if (action.equals("UP")) currentY += 1;
		else if (action.equals("RIGHT")) currentX += 1;
		else if (action.equals("DOWN")) currentY -= 1;
		else if (action.equals("LEFT")) currentX -= 1;
